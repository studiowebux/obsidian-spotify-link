...
export default class SettingsTab extends PluginSettingTab {
	...
	display(): void {
		...
		divDoc
			...
			.createEl("li", { text: "{{ genres }} — artist genres, comma-separated, deduplicated" })
			.createEl("li", { text: "{{ genres_array }} — artist genres as YAML/Dataview array" })
			...
			.createEl("li", { text: "{{ album_genres }} — deprecated, usually renders _deprecated_ (fetches the album)" })
			.createEl("li", { text: "{{ album_genres_array }} — deprecated, usually renders _deprecated_" })
			.createEl("li", { text: "{{ album_genres_hashtag }} — deprecated, usually renders _deprecated_" })
			...
			.createEl("li", { text: "{{ album_popularity }} — deprecated, renders _deprecated_ (fetches the album)" })
